  ...
  return (
    <footer className="border-t border-slate-200 bg-white py-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 text-sm text-slate-600 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <p className="text-slate-700">© {new Date().getFullYear()} Make My Rental. Trusted rental forms for modern operators.</p>
        <div className="flex flex-wrap gap-4">
          ...
          <a href="mailto:hello@makemyrental.com" className="text-slate-700 hover:text-slate-900">
            Talk to sales
          </a>
        </div>
      </div>
