...
export const contractFormSchema = z.object({
  ...
  partyOneName: z.string().min(2, "Please fill your legal or company name."),
  partyOneAddress: z.string().min(5, "Add your mailing address so notices work."),
  partyTwoName: z.string().min(2, "Please fill the client’s legal name."),
  partyTwoAddress: z.string().min(5, "Add the client’s mailing address."),
  effectiveDate: z.string().min(4, "Select when the contract should start."),
  termStart: z.string().optional(),
  termEnd: z.string().optional(),
  governingLaw: z.enum(US_STATES),
  relationshipSummary: z.string().min(10, "Explain what both sides agreed to."),
